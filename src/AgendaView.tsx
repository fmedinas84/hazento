...
function WeekCalendar({ events, dayOnly, onOpen, openRequestIds }: { events: CalendarEvent[]; dayOnly: boolean; onOpen: (event: CalendarEvent) => void; openRequestIds: Set<string> }) {
