...
export function EngagementDetailView({ labels, go, onCreate }: { labels: Labels; go: Navigate; onCreate: (type?: string, accountId?: number) => void }) {
